...
import imageForFilter1 from './images/imageForFilter1_648x448.png';
import imageForFilter2 from './images/imageForFilter2_648x448.png';
import imageForFilter3 from './images/imageForFilter3_648x448.png';
    ...
    <div className={classes}>
      ...
      <div className={css.filteredSearches}>
        <FilterLink
          ...
          link="http://localhost:3000/s?pub_brand=alo-yoga"
        />
        <FilterLink
          name="Sweaty Betty"
          image={imageForFilter2}
          link="http://localhost:3000/s?pub_brand=sweaty-betty"
        />
        <FilterLink
          name="Gymshark"
          image={imageForFilter3}
          link="http://localhost:3000/s?pub_brand=gymshark"
        />
      </div>
    </div>
  );
