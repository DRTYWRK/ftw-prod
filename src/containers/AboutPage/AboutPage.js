        ...
        <LayoutWrapperMain className={css.staticPageWrapper}>
          ...
          <div className={css.contentWrapper}>
            <div className={css.contentSide}>
              <p>"We want to change people's minds about resale activewear. If you recycle plastic bottles and containers, you should also be recycling your plastic clothing aka leggings."</p>
            </div>
            ...
            <div className={css.contentMain}>
              ...
              <p>With DRTYWRK, we want to make sure you're transaction will go smoothly: from browsing and checking the stock, to making the order and payment, to the review of the sellers. And we hope you'll be so convinced that you'll soon start selling your no longer used items to make new buyers happy!</p>

              <h3 className={css.subtitle}>Do you have activewear to sell?</h3>

              <p>
                DRTYWRK offers you a good way to earn some extra cash! If you're not using your
              ...
              <p>Fees: 
                <li>Sell yourself and keep 80% of the sale. 
                </li>

                <li>Have a large number of items to sell and don't have the time? Contact us <a href="mailto:hello@drtywrk.com">here</a> and we'll wash, list and ship for a fee.</li>
              </p>
